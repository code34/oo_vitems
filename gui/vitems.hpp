	...
	class controlsBackground {
		class OOP_MainLayer_100_100 : OOP_MainLayer {
			...
			class controls{
				...
				class OOP_Text_Description_104: OOP_StructuredText {
					idc = 104;
					x = 37.9228 * pixelGrid * pixelW;
